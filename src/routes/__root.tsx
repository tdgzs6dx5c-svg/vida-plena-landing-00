...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Clínica Vida Plena | Cuidado e Bem-Estar" },
      { name: "description", content: "Atendimento humanizado, exames e especialistas. Agende sua consulta na Clínica Vida Plena." },
      { name: "author", content: "Clínica Vida Plena" },
      { property: "og:title", content: "Clínica Vida Plena | Cuidado e Bem-Estar" },
      { property: "og:description", content: "Atendimento humanizado, exames e especialistas. Agende sua consulta na Clínica Vida Plena." },
